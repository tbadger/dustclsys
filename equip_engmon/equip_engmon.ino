...
EnergyMonitor tool1, tool2, tool3, tool4;   // Create instances for shop equipment - Table Saw, Miter Saw, CNC Router, etc.
...
unsigned long startupCounter = 0; //for delaying the premature startup of the dust collector
